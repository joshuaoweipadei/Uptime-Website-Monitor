...
workers.gatherAllChecks = function(){
    ...
    _data.list('checks', function(err, checks){
        if(!err && checks && checks.length > 0){
            ...
            console,log('Error: Could not find any chechks to process')
        }
    });
}
...
workers.validateCheckData = function(originalCheckData){
    ...
    originalCheckData.successCode = typeof(originalCheckData.successCode) == 'object' && originalCheckData.successCode instanceof Array && originalCheckData.successCode.length > 0 ? originalCheckData.method : false;
